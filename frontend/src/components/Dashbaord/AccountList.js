            ...
            {accounts?.length <= 0 ? (
              <>
                ...
                <a
                  ...
                  className="px-6 py-3 text-lg font-medium text-white bg-blue-500 rounded-md hover:bg-blue-400"
                >
                  Create Account
                </a>
              </>
              ...
              <>
                ...
                <div className="max-w-4xl mx-auto  mb-12 text-center">
                  ...
                  <Link
  to="/add-account"
  className="inline-flex m-8 items-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
>
  Add New Account
</Link>
                ...
                {accounts?.map(acc => {
                  return (
                    <a className="group block mb-6" href="#">
                      <div className="flex items-center justify-between flex-wrap p-10 group-hover:bg-coolGray-100 rounded-md shadow-md transition duration-200">
